	...
	static String showSummary(User user,Assignment a) {
		...
		try {
			...
			if (nMismatched > 0) {
				...
				buf.append("<form method=post action=/VideoQuiz onsubmit=\"document.getElementById('syncScores').disabled=true;document.getElementById('syncScoresStatus').style.display='inline';return true;\">"
